...
python train_mul_times.py FingerMovements  ctrl --loader  UEA --batch-size 128  --max-threads 8   --iters 200 --eval --taskW 0.1 --hard-neg mix2 --debiase --threshold 0.99 --topk 0.2
python train_mul_times.py Handwriting ctrl --loader  UEA --batch-size 128  --max-threads 8   --iters 200 --eval --taskW 0.05 --hard-neg shuffle8 --debiase --threshold 0.99 --topk 0.2
